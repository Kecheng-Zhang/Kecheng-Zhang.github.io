...
首先，不能像八方旅人那样以剧情设计为主体，对话，过场动画和流程都会消耗大量的时间和精力，除非设计成例如Galgame的文字类游戏。其次，沙盒或是战略类也不现实，这类游戏的核心是不同程度的复杂的系统，以提供玩家的深度交互，而复杂的系统又容易引起众多恶性Bug，因此不是个好选择。最后，需要庞大物理和美术支持才有良好体验的游戏自然也难以在短时间内实现，比如赛车类，体育，或是模拟类游戏。
